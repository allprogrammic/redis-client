...
class Client
{
    ...
    public function forceStandalone()
    {
        ...
        if ($this->connected) {
            throw new Exception(
                'Cannot force Client to use standalone PHP driver after a connection has already been established.'
            );
        }
    ...
    public function connect()
    {
        ...
        if (! $result) {
            ...
            throw new Exception(sprintf(
                'Connection to Redis failed after %s failures.%s',
                $failures,
            ...
            if ($this->usePipeline) {
                if ($name == 'pipeline') {
                    ...
                    if ($this->isMulti) {
                        ...
                        $this->commands .= self::prepareCommand(array($this->getRenamedCommand($name)));
                    }
     ...
     * @return array
     */
    private static function flattenArguments(array $arguments, &$out = [])
    {
